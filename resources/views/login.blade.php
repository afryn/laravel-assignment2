...
<body>
                                ...
                                <div class="card-body p-md-5 mx-md-4">
                                    ...
                                    <form method="post" id="login_form" action="{{route('login.post')}}">
                                        ...
                                        <div class="d-flex align-items-center justify-content-center pb-4">
                                            ...
                                            <a href="{{route('signup')}}" data-mdb-button-init data-mdb-ripple-init class="btn btn-outline-danger">Create new</a>
                                        </div>
    ...
    <script>
        document.getElementById('login_form').addEventListener('submit', function(e) {
            e.preventDefault();
            if ($('#form2Example11').val().trim() == '') {
                toasterNotification('Please Enter Username');
            } else if ($('#form2Example22').val().trim() == '') {
                toasterNotification('Please Enter Password');
            } else {
                $.ajaxSetup({
                    headers: {
